...
#define mat arm_matrix_instance_f32 // 矩阵结构体
#define Matrix_Init arm_mat_init_f32 //初始化
...
#define Matrix_Transpose arm_mat_trans_f32 //计算矩阵转置
#define Matrix_Inverse arm_mat_inverse_f32 //计算矩阵的逆
